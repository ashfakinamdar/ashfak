            ...
            <Grid item xs={6}>
              <div className="container">
                <div className="flexLogin">
                  ...
                  <HdrStrongIcon style={{ fontSize: 40 }} />
                </div>
                <FormControl className="width100">
                  <Stack spacing={5}>
                    ...
                    <span
                      className={
                        errorUsername ? "passwordView2" : "passwordView"
                      }
                    >
                      {show ? (
              ...
              <Grid container className="textAlignCenter iconPadding">
                <Grid item xs={4}>
                  <FacebookIcon style={{ color: "#1e88e5", fontSize: 30 }} />
                </Grid>
                <Grid item xs={4}>
                  <GoogleIcon style={{ color: "#c62828", fontSize: 30 }} />
                </Grid>
                <Grid item xs={4}>
                  <TwitterIcon style={{ color: "#01579b", fontSize: 30 }} />
                </Grid>
              </Grid>
            </Grid>
